...
mod test {
  ...
  proptest!{
    #[test]
    fn pagination_should_create_from_int(num in 1..i32::MAX, size in 1..=100) {
    ...
    #[test]
    fn pagination_should_set_1_to_page_num_when_num_is_less_than_1(num in i32::MIN..=0, size in 1..=100) {
      let pagination = Pagination::from_int(num, size);
    ...
    #[test]
    fn pagination_should_set_default_to_size_when_size_is_less_than_1(num in 1..i32::MAX, size in i32::MIN..=0) {
      let pagination = Pagination::from_int(num, size);
      assert_eq!(pagination.num.value(), num as u32);
    ...
    #[test]
    fn pagination_should_calculate_offset(num in 1..i32::MAX, size in 1..=100) {
      let pagination = Pagination::from_int(num, size);
      assert_eq!(pagination.offset(), (size * (num - 1)) as u32);
    }

    #[test]
    fn pagination_should_calculate_limit(num in 1..i32::MAX, size in 1..=100) {
      let pagination = Pagination::from_int(num, size);
